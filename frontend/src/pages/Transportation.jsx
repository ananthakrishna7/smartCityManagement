    ...
    const fetchSchedules = async () => {
      const mockData = [
        ...
        },
        {
          ...
          time: "12:15 PM",
          fare: "₹55",
          stops: "Station D, Station E, Station F",
          status: "On Time",
        },
        {
          id: 11,
          type: "Metro",
          route: "Metro Yellow Line",
          time: "1:45 PM",
          fare: "₹60",
          stops: "Station G, Station H, Station I",
          status: "Delayed",
        },
        {
          id: 12,
          type: "Metro",
          route: "Metro Purple Line",
          time: "3:00 PM",
          fare: "₹65",
          stops: "Station J, Station K, Station L",
          status: "On Time",
        },
        {
          id: 13,
          ...
          time: "4:30 PM",
          fare: "₹70",
          stops: "Station M, Station N, Station O",
          status: "On Time",
        },
        {
          id: 14,
          type: "Metro",
          route: "Metro Pink Line",
          time: "6:00 PM",
          fare: "₹75",
          stops: "Station P, Station Q, Station R",
          status: "Delayed",
        },
        {
          id: 15,
          ...
          time: "11:00 AM",
          fare: "₹100",
          stops: "Junction 1, Junction 2, Junction 3",
          status: "On Time",
        },
        {
          id: 16,
          type: "Train",
          route: "Superfast Express",
          time: "1:00 PM",
          fare: "₹120",
        ...
        <tbody>
          {filteredSchedules.map((schedule) => (
            <tr key={schedule.id}>
              ...
              <td
                className={
                  schedule.status === "Delayed" ? "delayed" : "on-time"
                }
              >
                {schedule.status}
              </td>
